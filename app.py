...
def normalpizza():
    global orderTotal, userLoggedIn, loginfirst, amountPizzamar, costPizzamar
...
def carty():
    ...
    for i in range(len(pizzaOrderList)):
        ...
        if "Pizza caprese" in pizzaOrderList[i]:
            pizzaOrderList.pop(i)
            pizzaOrderList.append(("Pizza caprese",costPizzacap,amountPizzcap))
        else:
            pizzaOrderList.append(("Pizza caprese",costPizzacap,amountPizzcap))
    ...
    for i in range(len(dessertlust)):
